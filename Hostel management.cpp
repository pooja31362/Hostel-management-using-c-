...
class boyshostel{
	protected:
		...
		void mess1(){
			fstream s;
			s.open("messboys.txt",ios::out|ios::in|ios::app);
			cout<<"veg details:\n";
			cin>>ms;
			s<<"mess:"<<ms<<endl;
			s.close();
		...
		void mess2(){
			fstream s;
			s.open("messnboys.txt",ios::out|ios::in|ios::app);
			cout<<"nonveg details:\n";
			cin>>ms2;
			s<<"mess:"<<ms2<<endl;
			s.close();
...
if(n==2){
	...
	int choice;
	int op;
	cout<<"1- FOR BOYSHOSTEL:\n";
    cout<<"2- FOR GIRLSHOSTEL:\n";
	cin>>op;
	if(op==1){
	do{
